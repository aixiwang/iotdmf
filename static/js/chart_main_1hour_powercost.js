...
require(
    ...
    function (ec) {
        ...
        //--- 折柱 ---
        var myChart = ec.init(document.getElementById('power_cost_1hour'));
        ...
        function read_points() {
            var url = "/view/datapoints/powercost";
            xmlhttp=new XMLHttpRequest();
            xmlhttp.onreadystatechange=function() {
                if (xmlhttp.readyState==4) {
